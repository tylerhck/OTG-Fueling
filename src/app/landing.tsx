          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 max-w-3xl mx-auto">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-8 hover:shadow-lg transition-shadow">
              ...
              <ul className="mt-6 space-y-3">
                {["$15 delivery fee per order", "No account required", "ASAP or scheduled", "All fuel types"].map((item) => (
              ...
              <div className="mt-10 space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "$35/mo subscription includes one free delivery per week. Otherwise, $15 delivery fee. No surge pricing, no hidden costs.",
                    icon: (
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-6 text-xs text-slate-400">
            $35/mo for 1 free delivery per week. $15 delivery fee otherwise.
          </p>
        </div>
      </section>
    </div>
