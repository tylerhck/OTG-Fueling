        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 flex items-center justify-between rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
            <div>
              ...
              <p className="text-xs text-amber-700">A $40 hold will be placed on your card on the day of your fill-up. If the hold fails, no order ticket will be created and you will not receive service. You will only be charged for what you receive at time of completion. The hold is released upon completion.</p>
            </div>
            <button
              type="button"
          ...
          <div className="mt-3 space-y-2 text-sm">
            {form.isFillUp ? (
              <>
                ...
                <p className="text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2"><strong>Important:</strong> A $40 hold will be placed on your card on the day of your fill-up. If the hold fails, no order ticket will be created and you will not receive service. You will only be charged for what you receive at time of completion. The hold is released upon completion.</p>
              </>
            ) : (
              <>
                <div className="flex justify-between">
                  <span className="text-slate-600">{FUEL_TYPE_LABELS[form.fuelType as keyof typeof FUEL_TYPE_LABELS]} — ${form.dollarAmount.toFixed(2)} hold</span>
