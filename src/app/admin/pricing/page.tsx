    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
        ...
        <ul className="mt-2 space-y-1 text-sm text-slate-600">
          ...
          <li>
            <strong>Fuel Orders</strong> — Customers pre-fund a dollar amount or choose Fill Up ($40 hold). You enter the actual gallons and price per gallon at completion.
          </li>
          <li>
